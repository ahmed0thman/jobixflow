...
import { companies, transactions as seedTransactions } from '../../data/mock'
...
const PAGE_SIZE = 12
/** Shown inline; every other field of the model lives behind "All Filters". */
...
export function Transactions() {
  ...
  const autoFields = useMemo(() => inferFilterFields(seedTransactions, transactionFilterSchema), [])
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Every payment, fee, and payout across the platform"
        action={
